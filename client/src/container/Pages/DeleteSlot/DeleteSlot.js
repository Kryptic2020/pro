...
class DeleteSlot extends Component {
	...
	deleteHandler = () => {
		...
		axios
			.post('/api/calendar/delete', dataPost)
			.then((res) => {
								...
								this.state.selectedTable ? (
									<>
										...
										<p>
											{' '}
											{
												'Click "UNDO" to return or Click "DELETE SLOTS" to complete'
											}
										</p>
									</>
								) : (
									'	Select one Card of Slots for this operation.'
								)
							}
						/>
					</div>
