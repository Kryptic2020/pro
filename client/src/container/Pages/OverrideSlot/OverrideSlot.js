...
class OverrideSlot extends Component {
	...
	continueHandler = () => {
		...
		axios
			.post('/api/calendar/override', dataPost)
			.then((res) => {
				...
				<div className={classes.subcontainer}>
					...
					<div className={classes.switch}>
						<Selector
							...
							text={
								'By default your its Visible to clients, you change it to Invisible mode by shifting the selector below'
							}
							on={
								this.state.selector
									? 'Visible'
						...
						<Heading
							text={
								this.state.selectedTable ? (
									<>
										{
											'This is your selected Slot`s card.'
										}{' '}
										<p>
											{' '}
											{
												'Click "UNDO" to return or Click "OVERRIDE SLOTS" to complete'
											}
										</p>
									</>
								) : (
